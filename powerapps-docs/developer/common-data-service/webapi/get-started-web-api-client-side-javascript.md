---
title: Introducción a la API web de Common Data Service para aplicaciones (JavaScript de lado de cliente) | Microsoft Docs
...
search.app:
  ...
  - D365CE
---
# <a name="get-started-with-the-common-data-service-for-apps-web-api-client-side-javascript"></a>Introducción a la API web de Common Data Service para aplicaciones (JavaScript de lado de cliente)

<!-- TODO: 
> [!NOTE]
> ![This page is under construction. Check back soon!](../../media/under_construction.png "Coming soon") [!INCLUDE[cc-under-construction](../../includes/cc-under-construction.md)] -->

En recursos web HTML, secuencias de comandos de formularios o comandos de cinta de opciones puede usar JavaScript para realizar operaciones en los datos de Common Data Service para aplicaciones con la API web que se incluye con CDS for Apps.
...
Si usa una versión anterior del servicio Customer Engagement de Common Data Service para aplicaciones, siga las instrucciones disponibles en [Introducción a la API web de Common Data Service para aplicaciones de Microsoft (JavaScript de cliente)](https://msdn.microsoft.com/library/gg334279.aspx)  
