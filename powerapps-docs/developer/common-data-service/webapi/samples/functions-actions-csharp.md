---
title: 'Ejemplo de funciones y acciones de API web (C#) (Common Data Service para aplicaciones) | Microsoft Docs'
description: 'Este ejemplo demuestra cómo llamar a funciones y acciones enlazadas y sin enlazar, incluidas las acciones personalizadas, mediante la API web de Common Data Service para aplicaciones y C#.'
ms.custom: ''
ms.date: 10/31/2018
ms.reviewer: ''
...
Este ejemplo demuestra cómo llamar a funciones y acciones enlazadas y sin enlazar, incluidas las acciones personalizadas, mediante la API web de Common Data Service para aplicaciones.  
...
Vaya a [Ejemplo de funciones y acciones de Microsoft CRM API web (C#)](http://go.microsoft.com/fwlink/p/?LinkId=824047), descargue el archivo de ejemplo, Ejemplo de funciones y acciones de Microsoft CRM API web (CS).zip y extraiga su contenido en una carpeta local. Esta carpeta debe contener los siguientes archivos:  
...
|FunctionsAndActions.sln <br />FunctionsAndActions.csproj <br />Packages.config <br />AssemblyInfo.cs|El proyecto, la configuración del paquete NuGet, y los archivos de información de ensamblado de la solución Visual Studio 2015 estándar para este ejemplo.|  
