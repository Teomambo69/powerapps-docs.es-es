---
title: Ejemplo de operaciones básicas de API web (JavaScript de lado de cliente) (Common Data Service para aplicaciones) | Microsoft Docs
description: 'Este ejemplo muestra cómo realizar operaciones básicas CRUD (Crear, Recuperar, Actualizar y Eliminar) y de asociación y disociación en instancias de entidades usando JavaScript de lado de cliente y la API web de Common Data Service para aplicaciones.'
ms.custom: ''
ms.date: 10/31/2018
ms.reviewer: ''
...
Este ejemplo muestra cómo realizar operaciones básicas CRUD (crear, recuperar, actualizar y eliminar) y de asociación y disociación en instancias de la entidad mediante JavaScript del lado del cliente.  
  
> [!NOTE]
>  En este ejemplo se implementan las operaciones detalladas en el [Ejemplo de operaciones básicas de la API web](../web-api-basic-operations-sample.md) y se utilizan las construcciones comunes de JavaScript que se describen en [Ejemplos de API web (JavaScript del lado cliente)](../web-api-samples-client-side-javascript.md)
...
### <a name="webapibasicoperationshtml"></a>WebAPIBasicOperations.html

 El recurso web WebAPIBasicOperations.html proporciona el contexto en el que el código JavaScript se ejecutará.  
...
### <a name="webapibasicoperationsjs"></a>WebAPIBasicOperations.js

 El recurso web WebAPIBasicOperations.js es la biblioteca JavaScript que define las operaciones que este ejemplo realiza.  
...
[Ejemplo de operaciones condicionales de la API web (JavaScript del lado del cliente)](conditional-operations-client-side-javascript.md)<br />
