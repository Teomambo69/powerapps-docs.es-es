---
title: 'Ejemplo de datos de consulta de API web (C#) (Common Data Service para aplicaciones) | Microsoft Docs'
description: 'Este ejemplo muestra cómo realizar solicitudes de consultas básicas mediante la API web y C# de Common Data Service para aplicaciones'
ms.custom: ''
ms.date: 10/31/2018
ms.reviewer: ''
...
Este ejemplo muestra cómo realizar solicitudes de consultas básicas mediante la API web con C# de Common Data Service para aplicaciones  
  
> [!NOTE]
>  Este ejemplo implementa las operaciones de Common Data Service para aplicaciones y la salida de la consola detalladas en el [Ejemplo de consulta de datos en la API web](../web-api-query-data-sample.md) y utiliza las construcciones comunes de C# que se describen en [Ejemplos de API web (C#)](../web-api-samples-csharp.md).  
  
<a name="bkmk_prerequisites"></a>

## <a name="prerequisites"></a>Requisitos previos

Los requisitos previos de todos los ejemplos en C# de la API web de Common Data Service para aplicaciones se detallan en la sección [Requisitos previos](../web-api-samples-csharp.md#bkmk_prerequisites) del tema primario [Ejemplos de operaciones básicas de la API web (C#)](../web-api-samples-csharp.md).  
  
<a name="bkmk_runSample"></a>

## <a name="run-this-sample"></a>Ejecute este ejemplo
  
Vaya a [Ejemplo de datos de consulta de Microsoft CRM API web (C#)](http://go.microsoft.com/fwlink/p/?LinkId=824049), descargue el archivo de ejemplo, Ejemplo de datos de consulta de Microsoft CRM API web (CS).zip y extraiga su contenido en una carpeta local. Esta carpeta debe contener los siguientes archivos:  
  
|Archivo|Objetivo/descripción|  
|----------|--------------------------|  
|Program.cs|Contiene el código de origen primario para este ejemplo.|  
|App.config|El archivo de configuración de la aplicación, que contiene información de conexión con el servidor de Common Data Service para aplicaciones con marcadores.|  
|Autenticación.cs<br />Configuration.cs<br />Exceptions.cs|En la carpeta **Código de ayuda de la API Web**, estos archivos incluyen la biblioteca adicional detallada en [Usar la biblioteca de Ayuda de API web de Common Data Service para aplicaciones (C#)](../use-microsoft-dynamics-365-web-api-helper-library-csharp.md).|  
|QueryData.sln <br />QueryData.csproj <br />Packages.config <br />AssemblyInfo.cs|El proyecto, la configuración del paquete NuGet, y los archivos de información de ensamblado de la solución Visual Studio 2015 estándar para este ejemplo.|  
...
2.  Edite el archivo de configuración, App.config, para especificar información de conexión para el servidor de Common Data Service para aplicaciones.  Para obtener más información, consulte [Código auxiliar: clases de configuración](../web-api-helper-code-configuration-classes.md).  
3.  Ejecute el proyecto **QueryData** desde Visual Studio.  Todas las soluciones de ejemplo se configuran para ejecutarse en modo de depuración de forma predeterminada.  
