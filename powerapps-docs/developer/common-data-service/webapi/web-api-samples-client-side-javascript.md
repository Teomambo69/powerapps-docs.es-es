---
title: Ejemplos de operaciones de datos de API web (JavaScript de lado de cliente) (Common Data Service para aplicaciones) | Microsoft Docs
...
Si está usando una versión anterior de Customer Engagement de Common Data Service para aplicaciones, consulte [Ejemplos de API Web (JavaScript del lado cliente)](https://msdn.microsoft.com/library/mt770370.aspx)
