...
|Package Deployer `PackageDeployer.exe`|Se usa para implementar paquetes en las instancias de Common Data Service. El paquete es una unidad instalable que incluye soluciones. <br /> Más información: <br />[Implementar paquetes de soluciones](introduction-solutions.md#deploy-solution-packages)<br />[Cree paquetes para Package Deployer de Common Data Service](/dynamics365/customer-engagement/developer/create-packages-package-deployer)|
...
Más información: [Usar el servicio de la organización de Common Data Service](/dynamics365/customer-engagement/developer/use-microsoft-dynamics-365-organization-service)
...
Más información: [Cree paquetes para Package Deployer de Common Data Service](/dynamics365/customer-engagement/developer/create-packages-package-deployer)
