...
Este componente de ejemplo explora los distintos métodos disponibles como parte de la API de formato del marco de componentes de PowerApps.En este ejemplo, usted crea una serie de elementos de entrada que llaman a los métodos respectivos de la API de formato que coincide con el valor mostrado.
