...
El marco de componentes de PowerApps identifica el idioma del usuario y devuelve las cadenas del archivo de recursos específico del idioma cuando usted intenta acceder a la cadena utilizando el método `context.resources.getString`.
