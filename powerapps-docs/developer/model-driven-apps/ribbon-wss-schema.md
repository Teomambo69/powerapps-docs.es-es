---
title: Esquema WSS de cinta (aplicaciones basadas en modelos) | Microsoft Docs
description: La siguiente es la definición de esquema para los tipos de cintas de opciones WWS en un archivo de personalización de importación/exportación. Se incluye del esquema central de cinta de opciones.
ms.custom: ''
ms.date: 10/31/2018
ms.reviewer: ''
...
### <a name="see-also"></a>Vea también  
 ...
 [Esquema de tipos de cintas de opciones](ribbon-types-schema.md)   
 [Referencia de personalización XML](customization-xml-reference.md)
