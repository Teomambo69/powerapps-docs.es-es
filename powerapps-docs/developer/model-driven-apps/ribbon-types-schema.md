---
title: Esquema de tipos de cinta (aplicaciones basadas en modelos) | Microsoft Docs
description: La siguiente es la definición de esquema para la porción de tipos de cintas de opciones en un archivo de personalización de importación/exportación. Se incluye del esquema central de cinta de opciones.
ms.custom: ''
ms.date: 10/31/2018
ms.reviewer: ''
