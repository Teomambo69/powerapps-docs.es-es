...
3. En la página **Grupo** , escriba la siguiente información:
    ...
    - **Tipo de pertenencia**: asignado.
      ...
      > [!div class=mx-imgBorder]
      > ![Crear un grupo de seguridad para el servicio de Power BI Embedded](../media/powerbi-embed-security-group.png "Crear un grupo de seguridad para el servicio de Power BI Embedded")
...
3. En la página **grupos-todos los grupos** , busque el **portal Power BI Embedded** grupo de servicios y selecciónelo.
    ...
    > [!div class=mx-imgBorder]
    > ![Busque y seleccione el grupo de seguridad para Power BI Embedded servicio](../media/search-security-group.png "Busque y seleccione el grupo de seguridad para Power BI Embedded servicio")
...
6. Seleccione el miembro en el resultado de la búsqueda y, a continuación, elija **seleccionar**.
    ...
    > [!div class=mx-imgBorder]
    > ![Agregar miembro al grupo de seguridad para Power BI Embedded servicio](../media/add-member-powerbi-embed.png "Agregar miembro al grupo de seguridad para Power BI Embedded servicio")
...
5. En el campo **grupos de seguridad específicos** , busque el **portal Power BI Embedded** grupo de servicios y selecciónelo.
    ...
    > [!div class=mx-imgBorder]
    > ![Adición de un grupo de seguridad en Power BI portal de administración](../media/add-sg-powerbi.png "Adición de un grupo de seguridad en Power BI portal de administración")
...
2. Vaya a **configuración de la integración de Power BI** > **administrar el servicio Power BI Embedded**.
    ...
    > [!div class=mx-imgBorder]
    > ![Administrar servicio de Power BI Embedded](../media/manage-powerbi-embedded-button.png "Administrar servicio de Power BI Embedded")
...
3. En la ventana de **integración del servicio administrar Power BI Embedded** , seleccione **deshabilitar la integración del servicio de Power BI Embedded**.
    ...
    > [!div class=mx-imgBorder]
    > ![Deshabilitar servicio de Power BI Embedded](../media/disable-powerbi-embedded-window.png "Deshabilitar servicio de Power BI Embedded")
