...
|       Authentication/Registration/RememberBrowserEnabled        |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                Selecciona o desactiva una casilla ¿Recordarme? en la validación bifactorial (código de correo electrónico) para persistir la validación bifactorial del explorador actual. No se requerirá al usuario que pase la validación bifactorial para inicios de sesión posteriores mientras utilice el mismo explorador. Valor predeterminado: true                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
...
| Authentication/ApplicationCookie/LogoutPath                              | Si el el middleware proporciona LogoutPath, se redirigirá una solicitud a esa ruta en función de ReturnUrlParameter. Para obtener más información: [CookieAuthenticationOptions::LogoutPath](https://msdn.microsoft.com/library/dn385545.aspx).               |
| Authentication/ApplicationCookie/ReturnUrlParameter                      | ReturnUrlParameter determina el nombre del parámetro de cadena de consulta que es anexado por el middleware cuando un código de estado 401 No autorizado se cambia a una redirección 302 en la ruta de inicio de sesión. Para obtener más información: [CookieAuthenticationOptions::ReturnUrlParameter](https://msdn.microsoft.com/library/dn385546.aspx).                           |
