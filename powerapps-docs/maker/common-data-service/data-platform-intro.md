...
Las entidades de Common Data Service pueden aprovechar la lógica enriquecida del lado de servidor y la validación para garantizar la calidad de los datos y reducir el código repetitivo en cada aplicación que se crea y usa los datos de la entidad.
