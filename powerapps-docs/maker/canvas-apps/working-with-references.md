...
1. En la barra de navegación izquierda, seleccione**entidades**de **datos** > .
...
> [!div class="mx-imgBorder"]
> ![Entidades cuentas, equipos y usuarios en el panel datos](media/working-with-references/accounts-datasources.png)
...
> [!div class="mx-imgBorder"]
> ![Se ha agregado un control de cuadro combinado encima de la galería con la propiedad items establecida en users](media/working-with-references/filter-insert-combobox.png)
...
> [!div class="mx-imgBorder"]
> ![Galería filtrada basada en el valor establecido en el control de cuadro combinado](media/working-with-references/filter-accounts.png)
...
1. Mueva los controles copiados a la derecha de la galería.
    ...
    > [!div class="mx-imgBorder"]
    > ![Se movieron los controles que se han copiado a la derecha de la galería](media/working-with-references/patch-position.png)

1. Seleccione el control de **radio** copiado y, a continuación, cambie estas propiedades:

    - Elementos`[ "Users"; "Teams" ]`
    - Predeterminada`If( IsType( Gallery1.Selected.Owner; Users ); "Users"; "Teams" )`

    > [!div class="mx-imgBorder"]
    > ![Se ha quitado la opción All del control radio.](media/working-with-references/patch-noall.png) 
...
1. Seleccione el control de **cuadro combinado** visible y, a continuación, establezca la propiedad **DefaultSelectedItems** en esta fórmula:
    ...
    > [!div class="mx-imgBorder"]
    > ![Conjunto de propiedades predeterminado para el cuadro combinado de usuarios](media/working-with-references/patch-default-users.png)
...
1. Inserte un control de **botón** , muévalo debajo del control de **cuadro combinado** y, a continuación, establezca la propiedad Text `"Patch Owner"`del botón en.
...
> [!div class="mx-imgBorder"]
> ![Animación en la que se muestra la revisión del propietario con un usuario o un equipo](media/working-with-references/patch-allthree.gif)
...
> [!div class="mx-imgBorder"]
> ![Entidades cuentas, equipos, usuarios y contactos en el panel datos](media/working-with-references/customer-datasources.png)
...
| Ubicación | Ejemplo **Owner** | Ejemplo de **cliente** |
|----------|-----------|------------------|
...
| Propiedad filtrar **elementos** de radio | **[&nbsp;"Todos";&nbsp;"usuarios";&nbsp;"equipos"&nbsp;]** | **[&nbsp;"All";&nbsp;"Accounts"&nbsp;; "Contacts"&nbsp;]** |
...
> [!div class="mx-imgBorder"]
> ![Aplicación cliente derivada de la aplicación propietaria con cambios sencillos aplicados](media/working-with-references/customer-simple-update.png)
...
> [!div class="mx-imgBorder"]
> ![Animación que muestra cómo la selección de un elemento en la Galería cambia los otros controles y el formulario](media/working-with-references/regarding-allthree.gif)
...
> [!div class="mx-imgBorder"]
> ![Relaciones de la entidad de cuenta con respecto a las relaciones de uno a varios](media/working-with-references/activity-onetomany.png)
...
1. Establezca el diseño de la galería en **título**y, a continuación, establezca el campo título en **nombre de cuenta**.
    ...
    > [!div class="mx-imgBorder"]
    > ![Establecer el diseño en título para el control Galería en el panel Propiedades](media/working-with-references/activitypointer-account-name.png)

1. Agregue una segunda galería, cambie su tamaño y, a continuación, muévala al lado derecho de la pantalla.

1. Establezca la propiedad **elementos** de la nueva galería `Gallery2.Selected.Faxes`en.
...
> [!div class="mx-imgBorder"]
> ![Cambio de la propiedad de elementos de la segunda galería, cambiando de faxes a actividades](media/working-with-references/activitypointer-gallery.png)
...
> [!div class="mx-imgBorder"]
> ![Panel datos que muestra todas las entidades necesarias para la función IsType](media/working-with-references/activity-datasources.png)
...
> [!div class="mx-imgBorder"]
> ![Propiedad de texto expandido con más información para una llamada de teléfono](media/working-with-references/activitypointer-phonecall.png)
