...
* Conéctese a Common Data Service y actualizar una entidad desde la aplicación.
...
* Para mostrar y actualizar datos en un origen como Excel, SharePoint, Common Data Service o SQL Server, [agregar una galería](add-gallery.md), y [agregar un formulario](add-form.md).
