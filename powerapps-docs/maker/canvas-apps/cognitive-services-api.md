...
2. La aplicación almacena los datos que devuelve la API en tres [colecciones](working-with-variables.md#create-a-collection) diferentes: **languageCollect**, **sentimentCollect** y **phrasesCollect**.
