...
- [**Color** ](../functions/function-colors.md) enumeración: Especificar nombres de colores de las hojas de estilos en cascada, como en estos ejemplos:

  - **Color.Red**
  - **Color.Indigo**

- [**ColorValue** ](../functions/function-colors.md) función: Especificar cadenas de texto, como nombres de colores de las hojas de estilos en cascada y la notación hexadecimal código (**#**), como en estos ejemplos:
