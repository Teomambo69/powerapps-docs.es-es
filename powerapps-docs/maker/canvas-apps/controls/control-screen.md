...
**LoadingSpinner** (**ninguno**, **controles** o **datos**): Si no hay ninguno, no se mostrará el control de número. Cuando controla | Datos, mostrará el control de número hasta que todos los controles secundarios en el nivel de pantalla estén visibles. **Tenga en cuenta. No se tienen en cuenta los controles anidados.**

**LoadingSpinnerColor** : el color de relleno del control de carga.
