...
1. En el cuadro de diálogo **Abrir**, pulse o haga clic en un archivo de imagen y luego pulse o haga clic en **Abrir**.
1. Agregue un control **[Botón](control-button.md)** , muévalo al control **Agregar imagen** y establezca la propiedad **[AlSeleccionar](properties-core.md)** del control **[Botón](control-button.md)** en esta fórmula:<br>
...
1. Agregue un control **Galería vertical** y establezca su propiedad **[elementos](properties-core.md)** en **mypix**.
1. Seleccione el control **[imagen](control-image.md)** en la galería y establezca su propiedad **imagen** en **ThisItem. Value**.
1. Presione F5 y pulse o haga clic en el control **[Botón](control-button.md)** .
   
    La imagen del control **Agregar imagen** aparece en el control **mapas vertical** . Si la imagen no tiene la misma relación de aspecto que el control de **[imagen](control-image.md)** en el control **Galería vertical** , establezca la propiedad **[ImagePosition](properties-visual.md)** del control **[imagen](control-image.md)** para que **quepa**.
1. Pulse o haga clic en el control **Agregar imagen**, pulse o haga clic en **Abrir** y luego pulse o haga clic en el control **[Botón](control-button.md)** que agregó.
   
    La segunda imagen aparece en el control **Galería de imágenes**.
1. (opcional) Repita el paso anterior una o más veces y, a continuación, presione Esc para volver al área de trabajo predeterminada.
