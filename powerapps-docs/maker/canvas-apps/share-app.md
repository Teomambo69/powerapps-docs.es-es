...
1. Si la aplicación se conecta a los datos para los que los usuarios necesitan permisos de acceso, especifíquelo.
    ...
    > ![Asignación de un rol de seguridad](media/share-app/cds-assign-security-role.png)
...
> [!div class="mx-imgBorder"]  
> Los ![invitados reciben el correo electrónico del recurso compartido de aplicaciones] Los (media/share-app/guest_access_doc_4.png "invitados reciben el correo electrónico del recurso compartido de aplicaciones")
...
| | Interfaz | Authentication | Orígenes de datos accesibles |
|------|--------|----------|-------------------|
...
|---------------------------------------------------|------------------------------------------------------------------------|
| 10to8 Appointment Scheduling                      | Sin                                                                     |
| Adobe Creative Cloud                              | Sin                                                                     |
| Adobe Sign                                        | Sin                                                                     |
| Asana                                             | Sin                                                                     |
| Administrador de AtBot                                       | Sin                                                                     |
| Lógica de AtBot                                       | Sin                                                                     |
| Azure AD                                          | Sí                                                                    |
| Azure Automation                                  | Sí                                                                    |
...
| bttn                                              | Sin                                                                     |
| Buffer                                            | Sin                                                                     |
| Centro de negocios                                  | Sin                                                                     |
| CandidateZip                                      | Sin                                                                     |
| Cápsula CRM                                       | Sin                                                                     |
| Administración de PKI de nube                              | Sin                                                                     |
| Cognito Forms                                     | Sin                                                                     |
| Common Data Service                               | Sin                                                                     |
| Common Data Service (heredado)                      | Sin                                                                     |
| Optimizador D & B                                     | Sin                                                                     |
| Derdack convierte SIGNL4                                    | Sin                                                                     |
| Disqus                                            | Sin                                                                     |
| Combinación de documentos                                    | Sin                                                                     |
| Dynamics 365                                      | Sin                                                                     |
| Dynamics 365 AI para ventas                         | Sí                                                                    |
| Dynamics 365 para operaciones de fin &                        | Sin                                                                     |
| Enadoc                                            | Sin                                                                     |
| Eventbrite                                        | Sin                                                                     |
| Excel online (Business)                           | Sin                                                                     |
| Excel online (OneDrive)                           | Sin                                                                     |
| Recordatorio de expiración                               | Sin                                                                     |
| FreshBooks                                        | Sin                                                                     |
| GoToMeeting                                       | Sin                                                                     |
| GoToTraining                                      | Sin                                                                     |
| GoToWebinar                                       | Sin                                                                     |
| Harvest                                           | Sin                                                                     |
| HTTP con Azure AD                                | Sin                                                                     |
| Infusionsoft                                      | Sin                                                                     |
| Inoreader                                         | Sin                                                                     |
| Intercom                                          | Sin                                                                     |
| JotForm                                           | Sin                                                                     |
...
| Metatarea                                          | Sin                                                                     |
| Microsoft Forms                                   | Sin                                                                     |
| Microsoft Forms Pro                               | Sin                                                                     |
| Seguridad de Microsoft Graph                          | Sin                                                                     |
| Microsoft Kaizala                                 | Sin                                                                     |
| Microsoft School Data Sync                        | Sin                                                                     |
| Microsoft StaffHub                                | Sin                                                                     |
| Microsoft Teams                                   | Sí                                                                    |
| Microsoft to-do (Business)                        | Sin                                                                     |
| Muhimbi PDF                                       | Sin                                                                     |
| NetDocuments                                      | Sin                                                                     |
| Office 365 Groups                                 | Sí                                                                    |
| Office 365 Outlook                                | Sin                                                                     |
| Usuarios de Office 365                                  | Sí                                                                    |
| Office 365 Video                                  | Sin                                                                     |
| OneDrive                                          | Sin                                                                     |
| OneDrive para la Empresa                             | Sin                                                                     |
| OneNote (empresas)                                | Sin                                                                     |
| Outlook Customer Manager                          | Sin                                                                     |
| Tareas de Outlook                                     | Sí                                                                    |
| Outlook.com                                       | Sin                                                                     |
| Paylocity                                         | Sin                                                                     |
| Planner                                           | Sin                                                                     |
| Formularios de Plumsail                                    | Sin                                                                     |
| Power BI                                          | Sí                                                                    |
| Project Online                                    | Sin                                                                     |
| Integración del diseño de ProjectWise                    | Sin                                                                     |
| Recurso compartido ProjectWise                                 | Sin                                                                     |
| SharePoint                                        | Sí                                                                    |
| SignNow                                           | Sin                                                                     |
| Skype empresarial online                         | Sin                                                                     |
| Soft1                                             | Sin                                                                     |
| Stormboard                                        | Sin                                                                     |
| Survey123                                         | Sin                                                                     |
| SurveyMonkey                                      | Sin                                                                     |
...
| Typeform                                          | Sin                                                                     |
| Vimeo                                             | Sin                                                                     |
| Equipos de WebEx                                       | Sin                                                                     |
| Protección contra amenazas avanzada de Windows Defender (ATP) | Sin                                                                     |
| Word online (empresa)                            | Sin                                                                     |
