...
description: Información de referencia para las funciones de filtro y búsqueda en Power Apps, incluidos ejemplos y sintaxis
author: gregli-msft
manager: kvivek
...
ms.locfileid: "74731080"
ms.PowerAppsDecimalTransform: true
---
# <a name="filter-search-and-lookup-functions-in-power-apps"></a>Funciones de filtrado, búsqueda y búsqueda en Power apps
