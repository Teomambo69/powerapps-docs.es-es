...
description: Información de referencia de la función JSON en Power Apps, incluida la sintaxis
author: gregli-msft
manager: kvivek
...
ms.locfileid: "74730732"
---
# <a name="json-function-in-power-apps"></a>Función JSON en Power apps

Genera una cadena de texto JSON para una tabla, un registro o un valor.

## <a name="description"></a>Descripción

La función **JSON** devuelve la representación notación de objetos JavaScript (JSON) de una estructura de datos como texto para que sea adecuada para el almacenamiento o la transmisión a través de una red. [ECMA-404](https://www.ecma-international.org/publications/files/ECMA-ST/ECMA-404.pdf) y [IETF RFC 8259](https://tools.ietf.org/html/rfc8259) describen el formato, que es ampliamente utilizado por JavaScript y otros lenguajes de programación.
