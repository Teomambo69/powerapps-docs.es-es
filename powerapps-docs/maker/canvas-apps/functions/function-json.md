...
| **Imagen, medios** | Si se especifica **IncludeBinaryData** , los archivos multimedia se codifican en una cadena. Referencias Web que usan http: o https: El esquema de dirección URL no se modifica. Las referencias a los datos binarios en memoria se codifican con el formato ["Data:*Mimetype*; Base64,..."](https://en.wikipedia.org/wiki/Data_URI_scheme) . Los datos en memoria incluyen imágenes que los usuarios capturan mediante el control de [**cámara**](../controls/control-camera.md) y cualquier otra referencia con el appres: y el BLOB: Esquemas de dirección URL.| `"data:image/jpeg;base64,/9j/4AA..."` |
...
| **Opción @ no__t-1set** | Valor numérico del conjunto de opciones, no la etiqueta que se usa para la presentación. El valor numérico se usa porque es independiente del lenguaje.  | `1001` |
...
| **Dos @ no__t-1option** | Valor booleano de la opción dos, *true* o *false*, no la etiqueta que se usa para la presentación. El valor booleano se usa porque es independiente del lenguaje. | `false` |
...
1. Seleccione el botón mientras mantiene presionada la tecla Alt.
    ...
    > @no__t-colección 0CitiesByCountry @ no__t-1

    También puede mostrar esta colección seleccionando **archivo** > **configuración de aplicación** > **Configuración avanzada** >  habilitar la vista de resultados de la barra de**fórmulas**, seleccionando el nombre de la colección en la barra de fórmulas y seleccionando a continuación el flecha abajo situada junto al nombre de la colección en la barra de fórmulas.

    > [!div class="mx-imgBorder"]
    > ![Collection en la vista de resultados de la barra de fórmulas @ no__t-1
