...
description: Información de referencia de las funciones Now, hoy y Eshoy en Power Apps, con sintaxis y ejemplos
author: gregli-msft
manager: kvivek
...
ms.locfileid: "74730531"
ms.PowerAppsDecimalTransform: true
---
# <a name="now-today-and-istoday-functions-in-power-apps"></a>Funciones ahora, hoy y Eshoy en Power apps
