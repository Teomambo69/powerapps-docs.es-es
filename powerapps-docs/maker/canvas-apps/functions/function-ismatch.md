...
| Fórmula | Descripción | Resultado |
|--------|------------|-----------|
| `Match( "Bob Jones <bob.jones@contoso.com>"; "<(?<email>" & Match.Email & ")>"` | Extrae solo la parte de correo electrónico de la información de contacto.  | {<br>correo electrónico: &nbsp; "bob.jones@contoso.com",<br>FullMatch: &nbsp; "&lt; @ no__t-2 >",<br>Subcoincidencias: &nbsp; [&nbsp; "bob.jones@contoso.com" &nbsp;],<br>StartMatch: 279<br>}  
