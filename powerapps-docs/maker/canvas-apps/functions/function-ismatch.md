...
Las expresiones regulares se encuentran en distintos dialectos y Power apps usa una variante del dialecto de JavaScript. Consulte [Sintaxis de expresiones regulares](https://msdn.microsoft.com/library/1400241x.aspx) para obtener una introducción a la sintaxis. Se admiten las subcoincidencias con nombre (que a veces se denominan grupos de captura con nombre):
