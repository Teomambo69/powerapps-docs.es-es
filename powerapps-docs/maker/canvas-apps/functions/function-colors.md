...
La enumeración **Color** es una forma sencilla de tener acceso a los colores definidos por las hojas de estilo CSS de HTML. Por ejemplo, **Color.Red** devuelve un color rojo puro.  La lista de estos colores está incluida al final de este artículo.

La función **ColorValue** devuelve un color según una cadena de color CSS.  Se pueden usar ambos nombres de los colores CSS, como "RosyBrown" y los valores hexadecimales, como "#bc8f8f".

La función **RGBA** devuelve un color basado en los componentes de color rojo, verde y azul. También incluye un componente alfa que se usa para combinar colores de objetos ubicados en capa, una encima de la otra.  El componente alfa varía de 0 o 0 %, que es completamente transparente e invisible, a 1 o 100 %, que es completamente opaco y bloquea totalmente las capas que están más abajo.

La función **ColorFade** devuelve una versión más clara o más oscura de un color. La cantidad de atenuación varía de -1 o -100% (que oscurece completamente un color a negro) en 0 (lo que no influye en el color) a 1 o 100% (que ilumina totalmente un color en blanco).

## <a name="syntax"></a>Sintaxis

**Color**.*ColorName*

* *ColorName*: requerido.  El nombre de un color de hoja de estilo CSS.  Vea a continuación los posibles valores de enumeración.

**ColorValue**( *CSSColor* )

* *CSSColor*: requerido.  La definición de un color de hoja de estilo CSS.  Se pueden usar ambos nombres de los colores, como "OliveDrab" y los valores hexadecimales, como "#6b8e23".  

**RGBA**( *Red*; *Green*; *Blue*; *Alpha* )

* *Red*, *Green*, *Blue*: requerido.  Valores de los componentes de color, que van desde 0 (sin saturación) a 255 (saturación total).
* *Alpha*: requerido.  Componente alfa, que va desde 0 (completamente transparente) a 1 (completamente opaco). También puede usar un porcentaje, de 0 % a 100 %.

**ColorFade**( *Color*; *FadeAmount* )

* *Color*: requerido.  Un valor de color como **Color.Red** o el resultado de **ColorValue** o **RGBA**.
* *FadeAmount*: requerido.  Número entre -1 y 1.  -1 oscurece completamente un color hasta convertirlo en negro, 0 no afecta el color y 1 ilumina totalmente un color hasta convertirlo en blanco. También puede usar un porcentaje entre -100% a 100%
