...
description: Información de referencia para la función UpdateContext en Power Apps, incluidos ejemplos y sintaxis
author: gregli-msft
manager: kvivek
...
ms.locfileid: "74729911"
ms.PowerAppsDecimalTransform: true
---
# <a name="updatecontext-function-in-power-apps"></a>Función UpdateContext en Power apps
