...
description: Información de referencia para las funciones Sort y SortByColumns en Power Apps, con sintaxis y ejemplos
author: gregli-msft
manager: kvivek
...
ms.locfileid: "74730144"
---
# <a name="sort-and-sortbycolumns-functions-in-power-apps"></a>Funciones Sort y SortByColumns en Power apps
