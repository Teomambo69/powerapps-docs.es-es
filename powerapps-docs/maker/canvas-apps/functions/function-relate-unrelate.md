...
Considere una entidad **Products** con las siguientes relaciones, tal como se ha visualizado en el [visor de entidades del portal de PowerApps](../../common-data-service/create-edit-entities-portal.md):
