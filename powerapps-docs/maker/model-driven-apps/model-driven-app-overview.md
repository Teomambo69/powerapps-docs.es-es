...
### <a name="composing-the-app"></a>Composición de la aplicación
...
[Crear una entidad personalizada en PowerApps](../common-data-service/create-custom-entity.md)
