---
title: Crear cuadrículas (listas) editables de aplicaciones controladas por modelos mediante el control personalizado Cuadrícula editable con PowerApps | MicrosoftDocs
