...
**Sugerencia:** El [paquete de descarga](https://aka.ms/o4ia0f) para este escenario incluye una versión terminada de la aplicación: project-requests-app.msapp.
...
## <a name="step-4-customize-the-apps-details-screen-and-edit-screen"></a>Paso 4: Personalización de la pantalla de detalles y la pantalla de edición de la aplicación
...
3. En el panel derecho, arrastre el campo **Title** a la parte superior.
    ...
    ![Campo Title](./media/sharepoint-scenario-generate-app/02-04-02-title-field.png)
...
4. Haga clic o pulse en ![Icono Lápiz (edición)](./media/sharepoint-scenario-generate-app/icon-pencil.png) para editar el elemento.
