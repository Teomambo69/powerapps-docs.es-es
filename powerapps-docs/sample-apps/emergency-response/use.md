...
- **Capacidad de camas**
    <br> Recopile información sobre camas, como camas autorizadas, camas de UCI y otros datos de capacidad de camas.
...
- **Equipamiento**
    <br> Rastree la información del equipamiento, como respiradores, NIPPV y PAPR.

- **Personal**
    <br> Recopile información sobre el número de pacientes y el estado de RN, como partneres, asignados, solicitados y no asignados.
...
Envíe información relacionada con las camas, como las camas autorizadas, camas de UCI (SAIA/no SAIA), camas de cuidados intensivos (SAIA/no SAIA) y si la instalación seleccionada dispone de personal para toda su capacidad de camas autorizadas.
...
Después de enviar los datos, tiene la opción de volver a la aplicación **Capacidad de camas** para crear otro registro utilizando el botón **Seguir otro**. Seleccione **Inicio** para volver a la **Aplicación Hospital Emergency Response**.
...
| Número de camas de UCI (sala SAIA) actualmente en uso               | Número de camas de UCI (sala SAIA) actualmente en uso.                                      |
| Número de camas de UCI (sala no SAIA) actualmente en uso           | Número de camas de UCI (sala no SAIA) actualmente en uso.                                  |
| Número de camas de cuidados intensivos (sala SAIA) actualmente en uso        | Número de camas de cuidados intensivos (sala SAIA) actualmente en uso.                               |
| Número de camas de cuidados intensivos (sala no SAIA) actualmente en uso    | Número de camas de cuidados intensivos (sala no SAIA) actualmente en uso.                           |
| ¿El centro dispone de personal para toda su capacidad de camas autorizadas?    | Sí/No Si la respuesta es No, tiene la opción de seleccionar todos los motivos que correspondan: <br> - Personal <br> - Espacio <br> - EPI <br> - Equipamiento <br> - Bajo volumen de pacientes |
| ¿Puede aumentar el número de camas por encima de las autorizadas?              | Sí/No Si la respuesta es No, tiene la opción de seleccionar todos los motivos que correspondan: <br> - Personal <br> - Espacio <br> - EPI <br> - Equipamiento <br> - Bajo volumen de pacientes  |
| Número de camas suplementarias actualmente en uso                         | Número de camas suplementarias actualmente en uso.                                                |
...
| Cinturones para PAPR (respiradores purificadores de aire forzado)        | Número de cinturones para respiradores purificadores de aire forzado en uso.                                                         |
| Cargadores para PAPR        | Número de cargadores para respiradores purificadores de aire forzado en uso.                                                         |
| Capucha para PAPR        | Número de capuchas para respiradores purificadores de aire forzado en uso.                                                         |
...
| % del personal sanitario esencial ausente actualmente en estas instalaciones                  | Personal de atención esencial actualmente ausente como porcentaje del total para las **instalaciones completas**.                    |
...
Puede compartir sus comentarios con la opción **Comentarios sobre la aplicación** desde cualquier componente de la aplicación móvil de Respuesta de emergencia. Para compartir sus comentarios, seleccione su perfil en la esquina superior izquierda y luego seleccione el botón **Enviar comentarios**:
