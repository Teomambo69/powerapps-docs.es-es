...
|Seguir y establecer referente para tareas|Sin|Sí|  
|Establecer referente con un clic|Sí|Sin|  
|Muestra el resumen de los destinatarios|Sí|Sin|  
|Muestra el resumen de registros referentes en el correo electrónico o la cita|Sí|Sin|  
|Funciona con [!INCLUDE[pn_outlook_web_app](../includes/pn-outlook-web-app.md)]|Sí|Sin|  
|Funciona con [!INCLUDE[pn_Outlook_short](../includes/pn-outlook-short.md)] para escritorio|Sí|Sí|  
|Funciona con [!INCLUDE[pn_Outlook_short](../includes/pn-outlook-short.md)] para Mac|Sí|Sin|  
|Funciona con teléfonos|Sí|Sin|  
...
|Posibilidad de supervisar los mensajes de correo electrónico después de enviarlos|Sí|Sin|  
|Ordenar, filtrar, formatear, agrupar y clasificar vistas|Sin|Sí|  
|Crear documentos de combinación de correspondencia de Word|Sin|Sí|  
|Controlar la sincronización de los campos|Sin|Sí|  
...
## <a name="see-also"></a>Consulte también  
 ...
 [Agregar usuarios, licencias y roles de seguridad](https://msdn.microsoft.com/23612155-f92d-4871-a109-186419d5c19d)   
