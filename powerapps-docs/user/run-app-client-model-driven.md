...
description: Tutorial sobre cómo ejecutar una aplicación controlada por modelos en un dispositivo móvil
services: ''
suite: powerapps
...
> [Ejecución de una aplicación controlada por modelos en un dispositivo móvil](run-app-client.md)