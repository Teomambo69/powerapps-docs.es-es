...
description: Navegación básica en una aplicación controlada por modelos. En este artículo se explica cómo buscar y abrir una aplicación y cómo trabajar con sus elementos de interfaz de usuario comunes, como listas, formularios y procesos empresariales.
author: mduelae
manager: kvivek
...
- Las *aplicaciones* proporcionan una colección de funcionalidades para llevar a cabo una clase específica de actividad, como administrar las cuentas y los contactos. Use el menú del selector de aplicaciones para navegar entre las aplicaciones que están disponibles para su organización.

- Un *área de trabajo* es una subdivisión de una aplicación, dedicada a una característica específica. Cada área de trabajo proporciona una colección de entidades de destino para trabajar en esa área. En algunos casos, la misma entidad aparece en más de un área (o incluso en más de una aplicación). Las entidades contacto y cuenta, por ejemplo, aparecen en una variedad de aplicaciones y áreas de trabajo. Use el menú del área de trabajo para navegar entre las áreas de trabajo de la aplicación actual.

- Las *entidades* representan un tipo específico de datos, como contactos y cuentas. Las entidades utilizan un formato de datos estructurado, que define la colección de campos disponibles para la entidad. Cada entidad se compone de una colección de registros individuales. Por ejemplo, para la entidad contacto, cada registro describe una sola persona y cada registro incluye una colección de campos como el nombre, el apellido y la dirección de correo electrónico. Las entidades suelen presentar dos vistas: una vista de lista, que normalmente es una tabla que enumera los registros disponibles. y una vista de formulario, que muestra todos los datos y la configuración disponibles para un único registro. Use el navegador lateral para desplazarse entre las entidades del área de trabajo actual.
...
1. **Seleccionar registros**: para seleccionar uno o varios registros, coloque una marca de verificación en esta columna. En función de dónde esté trabajando, es posible que pueda aplicar una sola operación a todos los registros seleccionados a la vez mediante el uso de botones en la barra de comandos.
2. **Abrir un registro**: Seleccione cualquier registro de la lista para abrir su vista de registros, que muestra todos los detalles del registro. Normalmente, se selecciona en la columna **nombre** para abrir un registro de la entidad actual. Algunas entidades proporcionan vínculos a registros de entidades relacionadas en otras columnas (por ejemplo, un contacto relacionado).
...
Desplazarse por varios registros mediante vistas y consultas preestablecidas. La navegación centrada en los registros mejora la productividad, ya que los usuarios pueden ir directamente de un registro de la lista a otro y volver atrás fácilmente sin perder la lista de trabajo.
...
El panel de referencia es una excelente manera de hacer el trabajo sin salir de la pantalla en la que se encuentra. Puede buscar otros elementos relacionados&mdash;como casos o oportunidades para una cuenta&mdash;en el contexto del registro que está viendo, sin tener que desplazarse a otras pantallas.

> [!div class="mx-imgBorder"]
> ![Panel de referencia](media/reference-panel1.png "Panel de referencias")

 Vea este vídeo para obtener más información sobre el panel de referencia:
...
Si solo hay una notificación, verá una sola línea.

![Ejemplo de notificaciones únicas](media/single_notification.png "Ejemplo de una notificación única")

### <a name="multiple-notifications"></a>Varias notificaciones

Si hay varias notificaciones, verá el número de notificaciones. Seleccione el botón de contenido adicional para ver cada mensaje.
