...
* Para más información, consulte [Crear y actualizar una colección en la aplicación](create-update-collection.md).
...
**Para agregar una fila a una colección**, use [Collect( DataSource, Item, ... )](functions/function-clear-collect-clearcollect.md):
...
**Para actualizar una fila de una colección**, use [UpdateIf( DataSource, Condition1, ChangeRecord1 [, Condition2, ChangeRecord2, ...] )](functions/function-update-updateif.md):
...
**Para eliminar una fila de una colección**, use [RemoveIf( DataSource, Condition [, ...] )](functions/function-remove-removeif.md):
