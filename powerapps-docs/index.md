   ...
   <div class="container">
      ...
      <ul class="pivots">
         <li>
            ...
            <ul id="home">
               <li>
                  <a href="#getstarted"><strong>Introducción</strong></a>
                  <ul id="getstarted"
                     class="cardsC">
                     <br/>                            
                     <li class="fullSpan">
                           ...
                           <div class="cardPadding">
                              <div class="card">
                                 ...
                                 <div class="cardText">
                                    ...
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/user/run-app-client-model-driven">En un dispositivo móvil (aplicación basada en modelos)</a></p>
                           ...
                           <div class="cardPadding">
                              <div class="card">
                                 ...
                                 <div class="cardText">
                                    ...
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/user/create-a-record">Creación de un registro</a></p>
               ...
               <li>
                  ...
                  <ul id="maker"
                     ...
                     <li>
                        <div class="container">
                           <p>Los creadores de aplicaciones pueden crear rápidamente aplicaciones empresariales personalizadas sin escribir código para administrar datos críticos de su organización. Puede crear tres tipos de aplicaciones en Power Apps: <strong>Aplicación de lienzo</strong>, <strong>Aplicación basada en modelo</strong> y <strong>Portal</strong>. <strong>Common Data Service</strong> es la plataforma de datos que permite almacenar y administrar de forma segura los datos que usan las aplicaciones empresariales. Más información: <a href="/powerapps/maker">Crear aplicaciones</a></p>
                           <hr/>
                           <br/>
                        </div>
                     </li>
                              ...
                              <div class="card">
                                 ...
                                 <div class="cardText">
                                    ...
                                    <ul>
                                       ...
                                       <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/maker/common-data-service/data-platform-create-business-rule">Aplicar la lógica de negocios</a></p>
                                       ...
                                       <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/maker/canvas-apps/working-with-formulas">Configurar funcionalidad de la aplicación</a></p>
                                       <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/maker/canvas-apps/edit-app">Administrar una aplicación</a></p>
                                       <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/maker/canvas-apps/share-app">Compartir una aplicación</a></p>
                                    </ul>
                                 </div>
                              </div>
                           </div>
                        ...
                        <div class="cardSize">
                           <div class="cardPadding">
                              <div class="card">
                                 ...
                                 <div class="cardText">
                                    <h3 style="font-size: 1.15rem">Aplicaciones basadas en modelos</h3>
                                    <hr/>
                                    ...
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/maker/model-driven-apps/guide-staff-through-common-tasks-processes">Aplicar la lógica de negocios</a></p>
                                    ...
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/maker/model-driven-apps/create-edit-dashboards">Usar paneles</a></p>
                                    ...
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/maker/model-driven-apps/share-model-driven-app">Compartir una aplicación</a></p>
                           ...
                           <div class="cardPadding">
                              <div class="card">
                                 ...
                                 <div class="cardText">
                                    ...
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/maker/portals/admin/admin-overview">Administración del portal</a></p>
                           ...
                           <div class="cardPadding">
                              <div class="card">
                                 ...
                                 <div class="cardText">
                                    ...
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/maker/common-data-service/relationships-overview">Relaciones entre entidades</a></p>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/maker/common-data-service/fields-overview">Campos</a></p>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/maker/common-data-service/cds-processes">Aplicar la lógica de negocios</a></p>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/maker/common-data-service/solutions-overview">Soluciones</a></p>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/power-platform/admin/wp-security">Seguridad en Common Data Service</a></p>
                                    ...
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/maker/common-data-service/data-platform-powerbi-connector">Crear informes de Power BI a partir de datos de Common Data Service</a></p>
                                 </div>
                              </div>
                           </div>
                        </div>
                           ...
                           <div class="cardPadding">
                              <div class="card">
                                 ...
                                 <div class="cardText">
                                    ...
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/power-platform/admin/get-help-support">Obtener Ayuda + soporte</a></p>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/power-platform/admin/opt-in-early-access-updates">Optar por recibir acceso anticipado a actualizaciones</a></p>
                           ...
                           <div class="cardPadding">
                              <div class="card">
                                 ...
                                 <div class="cardText">
                                    ...
                                    <hr/>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/power-platform/admin/data-integrator">Integrar datos en Common Data Service</a></p>
                           ...
                           <div class="cardPadding">
                              <div class="card">
                                 ...
                                 <div class="cardText">
                                    ...
                                    <hr/>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/power-platform/admin/pricing-billing-skus">Información general de licencias</a></p>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/maker/common-data-service/data-platform-entity-licenses">Requisitos de licencia para entidades</a></p>
                           ...
                           <div class="cardPadding">
                              <div class="card">
                                 ...
                                 <div class="cardText">
                                    ...
                                    <hr/>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/power-platform/admin/environments-overview">Información general de entornos</a></p>
                           ...
                           <div class="cardPadding">
                              <div class="card">
                                 ...
                                 <div class="cardText">
                                    ...
                                    <hr/>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="https://aka.ms/powerappsadminwhitepaper">Libro blanco: Administración de la implementación empresarial de Power Apps y Power Automate</a></p>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="https://docs.microsoft.com/power-platform/guidance/coe/starter-kit">Starter Kit del Centro de excelencia (CoE) de Power Apps</a></p>
                                 </div>
                              </div>
                           </div>
                        </div>
                           ...
                           <div class="cardPadding">
                              <div class="card">
                                 ...
                                 <div class="cardText">
                                    ...
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/maker/canvas-apps/offline-apps">Desarrollar aplicaciones con trabajo sin conexión</a></p>
                           ...
                           <div class="cardPadding">
                              <div class="card">
                                 ...
                                 <div class="cardText">
                                    ...
                                    <hr/>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/developer/model-driven-apps/customize-entity-forms">Personalizar formularios de entidad</a></p>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/developer/model-driven-apps/customize-entity-views">Personalizar vistas de entidad</a></p>
                                    ...
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/developer/component-framework/overview">Compilación de componentes personalizados (Power Apps component framework)</a></p>
                        ...
                        <div class="cardSize">
                           <div class="cardPadding">
                              <div class="card">
                                 ...
                                 <div class="cardText">
                                    <h3 style="font-size: 1.15rem">Trabajar con datos de Common Data Service</h3>
                                    <hr/>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/developer/common-data-service/webapi/overview">Usar API web</a></p>
                                    ...
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/developer/common-data-service/best-practices/work-with-data">Prácticas recomendadas</a></p>
                                 </div>
                              </div>
                           </div>
                        </div>
                           ...
                           <div class="cardPadding">
                              <div class="card">
                                 ...
                                 <div class="cardText">
                                    ...
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/developer/common-data-service/best-practices/work-with-metadata">Prácticas recomendadas</a></p>
                                 </div>
                              </div>
                           </div>
                        </div>
                           ...
                           <div class="cardPadding">
                              <div class="card">
                                 ...
                                 <div class="cardText">
                                    ...
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/developer/common-data-service/best-practices/business-logic">Prácticas recomendadas: extensiones de complementos y flujos de trabajo</a></p>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/developer/model-driven-apps/best-practices/business-logic">Prácticas recomendadas: ejemplo de script en Customer Engagement</a></p>
                                 </div>
                              </div>
                           </div>
                        </div>
                           ...
                           <div class="cardPadding">
                              <div class="card">
                                 ...
                                 <div class="cardText">
                                    ...
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/developer/common-data-service/compress-extract-solution-file-solutionpackager">Herramienta Empaquetador de soluciones</a></p>
                                    ...
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/developer/common-data-service/isv-app-management">Supervisión y administración de aplicaciones de ISV</a></p>
                        ...
                        <div class="cardSize">
                           <div class="cardPadding">
                              <div class="card">
                                 ...
                                 <div class="cardText">
                                    <h3 style="font-size: 1.15rem">Crear aplicaciones cliente para Common Data Service</h3>
                                    <hr/>
                        ...
                        <div class="cardSize">
                           <div class="cardPadding">
                              <div class="card">
                                 ...
                                 <div class="cardText">
                                    <h3 style="font-size: 1.15rem">Prácticas recomendadas</h3>
                                    <hr/>
                           ...
                           <div class="cardPadding">
                              <div class="card">
                                 ...
                                 <div class="cardText">
                                    ...
                                    <hr/>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/developer/common-data-service/reference/about-entity-reference">Referencia de entidad</a></p>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="https://docs.microsoft.com/dynamics365/customer-engagement/web-api/about?view=dynamics-ce-odata-9">Referencia de la API web</a></p>
                                    ...
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/developer/model-driven-apps/clientapi/reference">Referencia de API de cliente</a></p>
                                 </div>
                              </div>
                           </div>
                        </div>
                        ...
                        <div class="cardSize">
                           <div class="cardPadding">
                              <div class="card">
                                 ...
                                 <div class="cardText">
                                    <h3 style="font-size: 1.15rem">Muestras</h3>
                                    <hr/>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/developer/common-data-service/webapi/quick-start-console-app-csharp">Inicio rápido: ejemplo de API web</a></p>
