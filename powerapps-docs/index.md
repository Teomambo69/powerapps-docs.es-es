---
layout: HubPage
title: Documentación de Microsoft PowerApps | Microsoft Docs
            ...
            <ul id="home">
                                 ...
                                 <div class="cardSize">
                                    <div class="cardPadding">
                                       <div class="card">
                                          ...
                                          <div class="cardText">
                                             <h3>¿Qué es PowerApps?</h3>
                                             <p>Empiece leyendo documentación con información general sobre PowerApps.</p>
                                          </div>
                                       </div>
                                    </div>
                                 </div>
                                 ...
                                 <div class="cardSize">
                                    <div class="cardPadding">
                                       <div class="card">
                                          ...
                                          <div class="cardText">
                                             <h3>Cursos sobre PowerApps</h3>
                                             <p>Eche un vistazo a las rutas de aprendizaje de Microsoft Learn que ofrecen instrucciones paso a paso para aprender más sobre PowerApps. Es gratuito.</p>
                                          </div>
                                       </div>
                                    </div>
                                 </div>
                                 ...
                                 <div class="cardSize">
                                    <div class="cardPadding">
                                       <div class="card">
                                          ...
                                          <div class="cardText">
                                             <h3>Blog</h3>
                                             <p>Lea el blog oficial de PowerApps para conocer los anuncios y las características más recientes de PowerApps.</p>
                                          </div>
                                       </div>
                                    </div>
                                 </div>
                                 ...
                                 <div class="cardSize">
                                    <div class="cardPadding">
                                       <div class="card">
                                          ...
                                          <div class="cardText">
                                             <h3>Comunidad</h3>
                                             <p>Conecte con compañeros, comparta ideas y aprenda de los expertos en el foro de la comunidad de PowerApps.</p>
                                          </div>
                                       </div>
                                    </div>
                                 </div>
                                 ...
                                 <div class="cardSize">
                                    <div class="cardPadding">
                                       <div class="card">
                                          ...
                                          <div class="cardText">
                                             <h3>Licencias</h3>
                                             <p>Conozca las distintas opciones de licencia para PowerApps.</p>
                                          </div>
                                       </div>
                                    </div>
                                 </div>
               ...
               <li>
                  ...
                  <ul id="maker"
                     ...
                     <li>
                        <div class="container">
                           <p>Los creadores de aplicaciones pueden crear rápidamente aplicaciones empresariales personalizadas sin escribir código para administrar datos críticos de su organización. Se pueden crear dos tipos de aplicaciones en PowerApps: <strong>aplicaciones de lienzo</strong> y <strong>aplicaciones basadas en modelos</strong>. <strong>CDS para aplicaciones</strong> es la plataforma de datos que permite almacenar y administrar de forma segura los datos que usan las aplicaciones empresariales. Más información: <a href="/powerapps/maker">Crear aplicaciones</a>.</p>
                           <hr/>
                           <br/>
                        </div>
                     </li>
                              ...
                              <div class="card">
                                 ...
                                 <div class="cardText">
                                    ...
                                    <ul>
                                       ...
                                       <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/maker/canvas-apps/data-platform-create-app">Generar una aplicación automáticamente</a></p>
                                       <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/maker/canvas-apps/data-platform-create-app-scratch">Crear una aplicación por su cuenta</a></p>
                                       <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/maker/canvas-apps/open-and-run-a-sample-app">Personalizar una aplicación de ejemplo</a></p>
                                       <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/maker/canvas-apps/customize-list-form">Personalizar un formulario de SharePoint</a></p>
                                       ...
                                       <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/maker/canvas-apps/reference-properties">Referencia sobre controles</a></p>
                                       <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/maker/canvas-apps/formula-reference">Referencia sobre fórmulas</a></p>
                        ...
                        <div class="cardSize">
                           <div class="cardPadding">
                              <div class="card">
                                 ...
                                 <div class="cardText">
                                    <h3 style="font-size: 1.15rem">CDS para aplicaciones</h3>
                                    <hr/>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/maker/common-data-service/data-platform-intro">CDS for Apps</a></p>
               ...
               <li>
                  ...
                  <ul id="admin"
                     ...
                     <li>
                        <div class="container">
                           <p>Los administradores pueden usar PowerApps y los centros de administración de Power Platform para proteger los datos, administrar entornos y supervisar el uso.</p>
                           <hr/>
                           <br/>
                        </div>
                     </li>
                           ...
                           <div class="cardPadding">
                              <div class="card">
                                 ...
                                 <div class="cardText">
                                    ...
                                    <hr/>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/administrator/environments-administration">Administrar entornos</a></p>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/administrator/database-security">Configurar la seguridad del entorno</a></p>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/administrator/admin-view-apps">Ver aplicaciones en el entorno</a></p>
                                 </div>
                              </div>
                           </div>
                        </div>
                           ...
                           <div class="cardPadding">
                              <div class="card">
                                 ...
                                 <div class="cardText">
                                    ...
                                    <hr/>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/administrator/data-integrator">Integrar datos en CDS para aplicaciones</a></p>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/administrator/powerapps-gdpr-dsr-guide">Responder a solicitudes de Data Subject Rights (DSR)</a></p>
                                 </div>
                              </div>
                           </div>
                        </div>
                           ...
                           <div class="cardPadding">
                              <div class="card">
                                 ...
                                 <div class="cardText">
                                    ...
                                    <hr/>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/administrator/pricing-billing-skus">Introducción a las licencias</a></p>
...
<!--                                   <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/administrator/powerapps-for-us-govt">PowerApps for US Government</a></p> -->
                           ...
                           <div class="cardPadding">
                              <div class="card">
                                 ...
                                 <div class="cardText">
                                    ...
                                    <hr/>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="https://docs.microsoft.com/power-platform/admin/admin-guide">Administrar Power Platform</a></p>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="https://docs.microsoft.com/power-platform/admin/get-help-support">Ayuda y soporte técnico</a></p>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="https://docs.microsoft.com/power-platform/admin/analytics-common-data-service">Análisis de CDS para aplicaciones</a></p>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="https://docs.microsoft.com/power-platform/admin/manage-environments">Administrar entornos</a></p>
                                 </div>
                              </div>
                           </div>
                        </div>
               ...
               <li>
                  ...
                  <ul id="developer"
                     ...
                     <li>
                        <div class="container">
                           <p>Los desarrolladores son <a href="/powerapps/?branch=release-crm-mig-vivek#pivot=home&panel=maker">creadores de aplicaciones</a> capaces de usar código para extender aplicaciones empresariales y crear aplicaciones cliente que se conecten a CDS para aplicaciones.</p>
                           <hr/>
                           <br/>
                        </div>
                     </li>
                           ...
                           <div class="cardPadding">
                              <div class="card">
                                 ...
                                 <div class="cardText">
                                    ...
                                    <hr/>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/developer/common-data-service/overview">CDS para aplicaciones: información general para desarrolladores</a></p>
                        ...
                        <div class="cardSize">
                           <div class="cardPadding">
                              <div class="card">
                                 ...
                                 <div class="cardText">
                                    <h3 style="font-size: 1.15rem">Trabajar con datos de CDS para aplicaciones</h3>
                                    <hr/>
                        ...
                        <div class="cardSize">
                           <div class="cardPadding">
                              <div class="card">
                                 ...
                                 <div class="cardText">
                                    <h3 style="font-size: 1.15rem">Trabajar con metadatos de CDS para aplicaciones</h3>
                                    <hr/>
                           ...
                           <div class="cardPadding">
                              <div class="card">
                                 ...
                                 <div class="cardText">
                                    ...
                                    <hr/>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/developer/common-data-service/plug-ins">Complementos (CDS para aplicaciones)</a></p>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/developer/common-data-service/workflow/workflow-extensions">Extensiones de flujo de trabajo (CDS para aplicaciones)</a></p>
                        ...
                        <div class="cardSize">
                           <div class="cardPadding">
                              <div class="card">
                                 ...
                                 <div class="cardText">
                                    <h3 style="font-size: 1.15rem">Integración de datos con CDS para aplicaciones</h3>
                                    <hr/>
                        ...
                        <div class="cardSize">
                           <div class="cardPadding">
                              <div class="card">
                                 ...
                                 <div class="cardText">
                                    <h3 style="font-size: 1.15rem">Crear aplicaciones cliente de CDS para aplicaciones</h3>
                                    <hr/>
                           ...
                           <div class="cardPadding">
                              <div class="card">
                                 ...
                                 <div class="cardText">
                                    ...
                                    <p><a class="barLink" style="font-size: 0.95rem" href="https://docs.microsoft.com/en-us/dynamics365/customer-engagement/web-api/about?view=dynamics-ce-odata-9">Referencia de API web</a></p>
