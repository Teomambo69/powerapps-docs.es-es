---
title: Problemas y soluciones habituales | Microsoft Docs
...
**Nota**: Para más información, consulte la [lista de problemas conocidos](https://docs.microsoft.com/en-us/common-data-service/entity-reference/known-issues) de Microsoft Common Data Service.
...
1. **Controles de la cámara en PowerApps Studio para Windows**
    ...
    Debido a una actualización de Windows, PowerApps Studio para Windows puede bloquearse si agrega un control de cámara o se abre una aplicación que utilice un control de cámara. Para evitar este problema, use [PowerApps Studio para web](create-app-browser.md) cuando agregue o use un control de cámara.
